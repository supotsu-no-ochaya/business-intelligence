...
from testdata.viewsets import CompanyExpenseViewSet, OrderItemViewSet, ProductViewSet, SpeiseViewSet, OrderViewSet, MesseEventViewSet
...
router.register(r'expense', CompanyExpenseViewSet, basename='companyexpense')
